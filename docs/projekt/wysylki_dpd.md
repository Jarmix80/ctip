...
Strona prototypów służy wyłącznie do porównywania układów. Jej skrypt nie wywołuje API, nie odczytuje Firebirda ani PostgreSQL i nie zapisuje decyzji. Docelowy proces operatora działa pod `/shipping`, poprzedni interfejs pozostaje pod `/shipping/legacy`, a dotychczasowy adres `/shipping/v2` przekierowuje do widoku głównego.
