...
3. Uruchom skrypt instalacyjny:
   ```powershell
   .\scripts\windows\install_service.ps1 -InstallDir "D:\CTIP"
   ```
   Skrypt:
...
- `install_service.ps1`, `update_ctip.ps1`, `uninstall_service.ps1`, `cleanup_ctip.ps1` – komplet narzędzi administracyjnych dla Windows Server 2022.
