  ...
  const adminUsers = () => ({
    ...
    normalizeSectionsForRole(sections, role) {
      ...
      input.forEach((item) => {
        ...
        if (
          !value ||
          !["admin", "operator", "generator", "delivery", "device", "shipping"].includes(
            value,
          )
        ) {
          return;
    ...
    resetForm() {
      ...
      this.form.canViewOrbitFinance = false;
    ...
    _buildPayload(source) {
      ...
      return {
        ...
        can_view_orbit_finance: Boolean(source.canViewOrbitFinance),
    ...
    async toggleActive(user) {
      ...
      try {
        ...
        if (this.modalOpen && this.modalDetail && this.modalDetail.id === user.id) {
          ...
          this.modalEdit.canViewOrbitFinance = Boolean(data.can_view_orbit_finance);
    ...
    openModal(userId) {
      ...
      this.modalEdit.canViewOrbitFinance = false;
