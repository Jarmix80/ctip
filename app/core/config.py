...
class Settings(BaseSettings):
    ...
    dpd_api_key: str | None = Field(default=None, alias="DPD_API_KEY")
    dpd_client_number: str | None = Field(default=None, alias="DPD_CLIENT_NUMBER")
    dpd_create_shipment_path: str = Field(default="/shipments", alias="DPD_CREATE_SHIPMENT_PATH")
    dpd_label_path_template: str = Field(
        default="/shipments/{shipment_id}/label?format=A4",
        alias="DPD_LABEL_PATH_TEMPLATE",
    )
