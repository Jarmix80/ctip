...
- Miesięczna historia MS CPC korzysta z tych samych tabel telemetrycznych, bez kopiowania faktur: trzy lata okresów urządzeń obecnie na aktywnych umowach, osobne liczniki początku i końca, historyczny klient oraz ostrzeżenia jakości. Konfiguracja i potwierdzone klucze MS: `docs/instal/telemetria_urzadzen.md`.
