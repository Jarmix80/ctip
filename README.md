...
- Moduł szybkich SMS normalizuje numer docelowy do formatu E.164 (obsługa prefiksów `00`, wiodącego `0` oraz korekta `+0`) przed zapisaniem w kolejce `sms_out`.
