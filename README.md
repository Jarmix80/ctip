...
- Chat wspiera zapytania biznesowe w języku naturalnym przez narzędzie `firebird_business_read` (intencje: `devices_by_company`, `monthly_average_print_by_model`, `company_monthly_print_summary`, `top_models_by_volume`, `device_monthly_print_by_serial`, `active_devices_on_contracts`, `active_devices_on_contracts_count`), np. „Wyświetl urządzenia firmy Steico”, „Pokaż średni miesięczny wydruk modelu MPC3004”, „Pokaż top modele po wydrukach”, „Pokaż historię serialu RNP12345” lub „Podaj mi ilość urządzeń aktywnych na umowach”.
