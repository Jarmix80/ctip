...
- Hotfix pełnego zamknięcia zleceń Shipping, naprawa `DATA_Z` i operatora oraz procedura korekty historycznej: `docs/instal/hotfix_shipping_pelne_zamkniecie_2026-09-08.md`.
