...
- `GET /genform` – osobny ekran handlowca do generowania i podglądu formularzy; domyślny widok `Wszystkie` łączy formularze aktywne i archiwalne, a jedno pole wyszukuje w wybranej kategorii po ID formularza, firmie, NIP, e-mailu, telefonie, kliencie Menadżera Serwisu i numerze proformy. Wiadomości historyczne pozostają osobnym widokiem z własnymi filtrami.
