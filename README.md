...
- Wycofanie PZ zachowuje historyczne wpisy `ctip.device_inventory_unit`, ale unikalność serialu i numeru KP obejmuje tylko urządzenia aktywne. Ponowne przyjęcie wcześniej wycofanego egzemplarza tworzy nowy aktywny wpis i nie usuwa historii; wyszukiwanie po tożsamości preferuje aktualny aktywny rekord.
