...
Gotowy skrypt wdrozenia sesji AI Asystenta na Windows Server (branch `codex/fix-public-form-checkbox-422`, commit `7e864a7`, kontrola Alembic i healthcheck) znajduje sie w `inbox/deploy_prod_ctip_assistant_2026-04-30.ps1`; uruchomienie: `.\inbox\deploy_prod_ctip_assistant_2026-04-30.ps1 -Apply`. Skrypt nie blokuje wdrozenia, gdy indeks wiedzy Firebird nie istnieje przed `git pull` i po aktualizacji automatycznie probuje go wygenerowac przez `scripts/build_firebird_knowledge_index.py`.
