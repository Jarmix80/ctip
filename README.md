...
- Strona `/flow/proforma/{id}` renderuje juz rzeczywista proforme odczytana z aktywnej konfiguracji Firebird (runtime z panelu administratora, ten sam co dla workflow/proformy); wariant `?variant=v1` jest domyslnym podgladem zblizonym do wzorca `inbox/FPROFORMA.pdf`.
