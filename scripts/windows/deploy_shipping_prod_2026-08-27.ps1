param(
    ...
    [string]$ReleaseBranch = "release/shipping-prod-2026-08-27",
    [string]$ExpectedCurrentCommit = "05780b848e3c7508099d8c9f9fe0a17ec0dab79b",
    [string]$ExpectedAlembicCurrent = "8a4d1f7c2b90",
